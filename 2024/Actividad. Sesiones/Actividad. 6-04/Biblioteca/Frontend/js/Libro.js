        ...
        success: function (response) {
            ...
            if (Array.isArray(data)) {
                data.forEach(function (item) {
                    ...
                    <td><button class="btn btn-primary modal-button" data-bs-dismiss="modal"  data-bs-target="#exampleModal" onclick="findById(${item.id})">Editar</button></td>
...
function findById(id) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            // $('#autorId').val(data.data.selectedAutor);
