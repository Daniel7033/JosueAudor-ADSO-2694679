...
function loadRegistros() {
    $.ajax({
        url: 'http://localhost:9000/biblioteca-backend/v1/api/registro/registros',
        method: "GET",
        dataType: 'json',
        success: function (response) {
            var html = '';
...
function findById(id) {
    selectedLibro = libroId.titulo;
    var selectedLector = lectorId.personaId;
    $.ajax({
        url: 'http://localhost:9000/biblioteca-backend/v1/api/registro/' + id,
        method: "GET",
        dataType: 'json',
        success: function (data) {
            ...
            $('#libroId').val(data.data.selectedLibro);
            $('#lectorId').val(data.data.selectedLector.nombre);
...
function libroTotal(){
    $.ajax({
        url: 'http://localhost:9000/biblioteca-backend/v1/api/libro/cantidad',
        method: 'GET',
        dataType: 'json',
        success : function(data){
