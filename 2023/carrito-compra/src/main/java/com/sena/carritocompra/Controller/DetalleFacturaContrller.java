...
public class DetalleFacturaContrller {
	...
	@PostMapping
	public DetalleFactura save(@RequestBody DetalleFactura df) {
		return service.save(df);
	}
	
	@PutMapping("{id}")
	public void save(@RequestBody DetalleFactura df, @PathVariable  Long id) {
		service.update(df, id);
	}
