 ...
 * @author Stork
 */
public class EliminarEstado extends javax.swing.JFrame {
    ...
    private void btnVolverContinenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVolverContinenteActionPerformed
        AjustesEstado cont = new AjustesEstado();
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        EliminarEstado eliminar = new EliminarEstado();
    ...
    public void mostrar() {
        ...
        try {
            ...
            while (rs.next()) {                
                ...
                estado[1] = rs.getString("codigo_postal");
                estado[2] = rs.getString("descripcion");
                estado[3] = rs.getInt("pais_id");
